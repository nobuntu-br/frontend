...
export class DatabaseCredentialFormComponent implements OnInit {
  ...
  */
  ...
  tenantId = new FormControl<number>(0);
  ...
  registerNewDatabaseCredential() {
    ...
    console.log(this.tenantId.value);
    ...
    this.databaseCredentialService._create({
      databaseCredential: this.databaseCredentialFormGroup.value,
