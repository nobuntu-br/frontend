...
export class ListEmployeesComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.EmployeesAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.employeesJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
