...
export class EmployeesFormComponent extends BaseResourceFormComponent<Employees> implements AfterViewInit, OnDestroy { 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected employeesService: EmployeesService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Employees(), employeesService, Employees.fromJson);//Linha alterável com base na classe 
