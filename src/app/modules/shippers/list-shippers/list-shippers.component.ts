...
export class ListShippersComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.ShippersAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.shippersJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
