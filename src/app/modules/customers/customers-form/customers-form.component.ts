...
export class CustomersFormComponent extends BaseResourceFormComponent<Customers> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.customersJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected customersService: CustomersService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Customers(), customersService, Customers.fromJson);//Linha alterável com base na classe 
