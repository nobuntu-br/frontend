...
export class ListCustomersComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.CustomersAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.customersJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
