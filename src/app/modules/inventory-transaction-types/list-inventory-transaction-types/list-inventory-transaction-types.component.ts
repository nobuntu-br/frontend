...
@Component({
  selector: 'app-list-inventory-transaction-types',
  templateUrl: './list-inventory-transaction-types.component.html',
  styleUrls: ['./list-inventory-transaction-types.component.scss']
})
export class ListInventoryTransactionTypesComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.InventoryTransactionTypesAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.inventoryTransactionTypesJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
