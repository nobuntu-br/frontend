...
export class ProductsFormComponent extends BaseResourceFormComponent<Products> implements AfterViewInit, OnDestroy { 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected productsService: ProductsService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Products(), productsService, Products.fromJson);//Linha alterável com base na classe 
