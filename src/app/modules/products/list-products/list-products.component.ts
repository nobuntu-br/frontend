...
export class ListProductsComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.ProductsAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.productsJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
