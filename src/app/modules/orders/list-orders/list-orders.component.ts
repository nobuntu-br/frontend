...
export class ListOrdersComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.OrdersAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.ordersJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
