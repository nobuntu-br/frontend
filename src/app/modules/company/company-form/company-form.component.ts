...
export class CompanyFormComponent extends BaseResourceFormComponent<Company> implements AfterViewInit, OnDestroy {


  JSONPath : string = environment.companyJSONPath;
...
//  private ngUnsubscribe = new Subject();
  ...
  constructor(
    protected companyService: CompanyService,//Linha alterável com base na classe
    protected injector: Injector,
    private generatedFormFactoryService: GeneratedFormFactoryService,
    private formGeneratorService: FormGeneratorService
  ) {
    super(injector, new Company(), companyService, Company.fromJson);//Linha alterável com base na classe
