...
export class ListCompanyComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.CompanyAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.companyJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
