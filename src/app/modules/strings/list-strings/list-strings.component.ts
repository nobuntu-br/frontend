...
export class ListStringsComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.StringsAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.stringsJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
