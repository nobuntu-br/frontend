...
export class ListApplicationComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.ApplicationAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.applicationJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
