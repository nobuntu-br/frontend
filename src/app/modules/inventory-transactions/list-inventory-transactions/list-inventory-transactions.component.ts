...
@Component({
  selector: 'app-list-inventory-transactions',
  templateUrl: './list-inventory-transactions.component.html',
  styleUrls: ['./list-inventory-transactions.component.scss']
})
export class ListInventoryTransactionsComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.InventoryTransactionsAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.inventoryTransactionsJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
