...
import { OrdersTaxStatusService } from "../shared/orders-tax-status.service"; 
...
@Component({
  selector: 'app-details-orders-tax-status',
  templateUrl: './orders-tax-status-form.component.html',
  styleUrls: ['./orders-tax-status-form.component.scss']
})
export class OrdersTaxStatusFormComponent extends BaseResourceFormComponent<OrdersTaxStatus> implements AfterViewInit, OnDestroy { 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected ordersTaxStatusService: OrdersTaxStatusService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new OrdersTaxStatus(), ordersTaxStatusService, OrdersTaxStatus.fromJson);//Linha alterável com base na classe 
