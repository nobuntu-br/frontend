...
@Component({
  selector: 'app-list-orders-tax-status',
  templateUrl: './list-orders-tax-status.component.html',
  styleUrls: ['./list-orders-tax-status.component.scss']
})
export class ListOrdersTaxStatusComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.OrdersTaxStatusAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.ordersTaxStatusJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
