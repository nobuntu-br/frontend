...
@Component({
  selector: 'app-list-company-application-token',
  templateUrl: './list-company-application-token.component.html',
  styleUrls: ['./list-company-application-token.component.scss']
})
export class ListCompanyApplicationTokenComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.CompanyApplicationTokenAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.companyApplicationTokenJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
