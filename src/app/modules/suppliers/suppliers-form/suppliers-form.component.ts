...
@Component({
  selector: 'app-details-suppliers',
  templateUrl: './suppliers-form.component.html',
  styleUrls: ['./suppliers-form.component.scss']
})
export class SuppliersFormComponent extends BaseResourceFormComponent<Suppliers> implements AfterViewInit, OnDestroy { 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected suppliersService: SuppliersService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Suppliers(), suppliersService, Suppliers.fromJson);//Linha alterável com base na classe 
