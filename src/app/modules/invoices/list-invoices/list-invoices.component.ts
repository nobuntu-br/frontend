...
export class ListInvoicesComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.InvoicesAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.invoicesJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
