...
@Component({
  selector: 'app-details-invoices',
  templateUrl: './invoices-form.component.html',
  styleUrls: ['./invoices-form.component.scss']
})
export class InvoicesFormComponent extends BaseResourceFormComponent<Invoices> implements AfterViewInit, OnDestroy { 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected invoicesService: InvoicesService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Invoices(), invoicesService, Invoices.fromJson);//Linha alterável com base na classe 
